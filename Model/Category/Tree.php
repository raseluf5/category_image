...
namespace Rasel\CategoryImage\Model\Category;
...
class Tree
{
    ...
    protected function prepareCollection()
    {
        ...
        if ($this->flatState->isAvailable()) {
            $this->categoryCollection->addAttributeToSelect('category_image');
        } else {
            $this->categoryCollection->addAttributeToSelect('category_image', true);
        }
    }
    ...
    public function getTree($node, $depth = null, $currentLevel = 0)
    {
        ...
        $tree->setId($node->getId())
            ...
            ->setCategoryImage(empty($node->getCategoryImage()) ? '' : $node->getCategoryImage())
